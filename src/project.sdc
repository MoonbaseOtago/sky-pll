...
create_clock [ get_pins "pll/CLK" ]  -name clk_result -period 10
set_clock_uncertainty $::env(SYNTH_CLOCK_UNCERTAINTY) [ get_clocks clk_result ]
set_clock_transition $::env(SYNTH_CLOCK_TRANSITION) [ get_clocks clk_result ]

# rp2040_clk  and  fpga_clk  are mesochronous, and they never interact
set_clock_groups -asynchronous -group { rp2040_clk } -group { clk_result } 
